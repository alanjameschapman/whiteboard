...
ACCOUNT_EMAIL_VERIFICATION = 'none' # consider using 'mandatory' for production.
...
SUMMERNOTE_CONFIG = {
    ...
    'summernote': {
        ...
        'toolbar': [
            ['style', ['style']],
            ['font', ['bold', 'italic', 'underline', 'clear', 'superscript', 'subscript', 'strikethrough', 'removeFormat']],
            ['fontfamily', ['fontname']],
            ['fontsize', ['fontsize']],
